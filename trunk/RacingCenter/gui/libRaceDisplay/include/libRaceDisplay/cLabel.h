...
class cLabel : public QLabel
{
    ...
    void Init( const tUInt i_nColor, const tUInt8 i_nDriverID, const tUInt16 i_nValue );
...
public:
	...
	void setBackgroundColor(Qt::GlobalColor i_oColor);
