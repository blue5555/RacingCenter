...
Led::Led(int size, QWidget * parent) : WidgetWithBackground(parent)
{
  m_checked = true; 
  m_color = Qt::red;
  m_size = size;
...
void Led::paintEvent(QPaintEvent * /* event*/ )
{
  ...
  painter.drawEllipse(-(m_size*0.9/2),-(m_size*0.9/2), m_size*0.9, m_size*0.9); //-149,-149,299,299);
  painter.end(); 
...
void Led::initCoordinateSystem(QPainter & painter)
{
  ...
  painter.scale(side / m_size, side / m_size);
}
